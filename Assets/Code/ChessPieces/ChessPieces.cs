...
public class ChessPieces : MonoBehaviour
{
    ...
    public virtual List<Vector2Int> GetAvailableMoves(ref ChessPieces[,] board, int countX, int countY) {
...
// sets up base for all other child classes
